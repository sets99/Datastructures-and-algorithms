...
import ds.bst.BSTree;
import ds.bst.Employee;
import ds.bst.EmployeeType;



class TestBSTLamdaFindIteratively {
	...
	void testFindRoot() {
		...
		// Act
		Employee found = defaultEmployeeTree.findIteratively(searchItem);
		// Assert
